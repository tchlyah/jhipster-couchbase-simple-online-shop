...
public class AddressResource {
    ...
    public ResponseEntity<Address> updateAddress(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, address.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Address> partialUpdateAddress(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, address.getId()));
    }
    ...
    public ResponseEntity<List<Address>> searchAddresses(
        ...
        Page<Address> page = addressRepository.search(query, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }
}
